class KatAppEventFluentApi{app;elements;constructor(e,t){this.app=e,this.elements=t}on(e,i){var a=e.split(" ");return this.elements.forEach(t=>{a.forEach(e=>t.addEventListener(e,i))}),this}off(e){var t=e.split(" ");return this.elements.forEach(i=>{null!=i.kaEventListeners&&t.forEach(t=>{var e=i.kaEventListeners[t];null!=e&&e.forEach(e=>i.removeEventListener(t,e.listener,e.options))})}),this}}class KatApp{selector;static applications=[];static globalEventConfigurations=[];static getDirty(){return this.applications.filter(e=>e.state.isDirty)}static remove(t){t.isMounted&&t.vueApp.unmount(),document.querySelector(`template[id$='${t.id}']`)?.remove(),this.applications=this.applications.filter(e=>e.id!=t.id)}static get(i){if("number"==typeof i)return this.applications[i];if("string"==typeof(i="object"==typeof i?i.closest("[ka-id]")?.getAttribute("ka-id")??"":i)&&""!=i){var e=this.applications.find(e=>e.id==i||e.selector==i);if(null!=e)return e;let t=document.querySelectorAll(i);if(1<(t=0!=t.length||i.startsWith(".")||i.startsWith("#")?t:document.querySelectorAll("."+i)).length)throw new Error("Unable to find a unique application with the key of "+i);if(1==t.length&&t[0].hasAttribute("ka-id"))return this.applications.find(e=>e.id==t[0].getAttribute("ka-id"))}}static handleEvents(e,t){var i={};t(i),this.globalEventConfigurations.push({selector:e,events:i})}static async createAppAsync(e,t){let i;try{return i=new KatApp(e,t),this.applications.push(i),await i.mountAsync(),i}catch(e){throw document.querySelector(".kaModal")?.remove(),null!=i&&KatApp.remove(i),e}}id;isCalculating;lastCalculation;options;state;el;traceStart;traceLast;missingResources=[];missingLanguageResources=[];applicationCss;vueApp;viewTemplates;mountedTemplates={};isMounted=!1;pushToTables=[];configureOptions;calcEngines=[];uiBlockCount=0;eventConfigurations=[];domElementQueued=!1;domElementQueue=[];updateDomPromise=Promise.resolve();constructor(e,t){this.selector=e,this.traceStart=this.traceLast=new Date;let s=this.id="ka"+KatApps.Utils.generateId();this.applicationCss=".katapp-"+this.id.substring(2);var i={inputCaching:this.isCalculating=!1,canProcessExternalHelpTips:!1,debug:{traceVerbosity:"1"===KatApps.Utils.pageParameters.tracekatapp?TraceVerbosity.Diagnostic:TraceVerbosity.None,showInspector:KatApps.Utils.pageParameters.showinspector??(null!=KatApps.Utils.pageParameters.localserver?"1":"0"),useTestCalcEngine:"1"===KatApps.Utils.pageParameters.test,useTestView:"1"===KatApps.Utils.pageParameters.testview,debugResourcesDomain:KatApps.Utils.pageParameters.localserver},calculationUrl:"https://btr.lifeatworkportal.com/services/evolution/CalculationFunction.ashx",katDataStoreUrl:"https://btr.lifeatworkportal.com/services/camelot/datalocker/api/kat-apps/{name}/download",kamlVerifyUrl:"api/katapp/verify-katapp",encryptCache:e=>"string"==typeof e?e:JSON.stringify(e),decryptCache:e=>e.startsWith("{")?JSON.parse(e):e},i=(this.options=KatApps.Utils.extend({},i,t),this.nextCalculation),i=(i.trace&&(i.originalVerbosity=this.options.debug.traceVerbosity,this.nextCalculation=i,this.options.debug.traceVerbosity=TraceVerbosity.Detailed),null==t.modalAppOptions?document.querySelectorAll(e):void 0);if(null!=i&&1!=i.length)throw new Error("'selector' of '"+this.selector+"' did not match any elements.");if(null==i&&null==t.modalAppOptions)throw new Error("No 'selector' or 'modalAppOptions' were provided.");this.el=i?.item(0)??this.createModalContainer(),this.domElementQueue=[this.el],this.el.setAttribute("ka-id",this.id),this.el.classList.add("katapp-css",this.applicationCss.substring(1)),null==this.el.getAttribute("v-scope")&&this.el.setAttribute("v-scope",""),null!=this.el.getAttribute("ka-cloak")||null==t.view&&null==t.content&&!1===(t.cloneHost??!1)||this.el.setAttribute("ka-cloak",""),null==document.querySelector("ka-resources")&&((e=document.createElement("ka-resources")).innerHTML=`<style>
