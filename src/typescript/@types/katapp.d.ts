...
declare class KatApp implements IKatApp {
     ...
     */
    static handleEvents(selector: string, configAction: (config: IKatAppEventsConfiguration) => void, key?: string): void;
    /**
     ...
     */
    static removeEvents(selector: string, key: string): void;
